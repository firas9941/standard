...
class Standard::Runners::GenignoreTest < UnitTest
  ...
  def test_todo_generated
    ...
    RuboCop::PathUtil.pwd if RuboCop::PathUtil.respond_to?(:pwd)
    ...
    expected_yaml = {"ignore" => [
      {"dont_call_it_tmp/genignore_test/errors_one.rb" => ["Lint/AssignmentInCondition"]},
      {"dont_call_it_tmp/genignore_test/errors_two.rb" => ["Lint/UselessAssignment"]}
    ]}
